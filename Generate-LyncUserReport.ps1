...
$LyncServers = @("LYNCIMFE1", "LYNCIMFE2")
# Define the Lync report output file location and name.
$LyncReportFile =  ".\LyncUserLogonReport.CSV"
...
$SearchOU = ("AD.company.com/" + $BaseOU.Replace("\","/")) 
...
If (!(Get-OrganizationalUnit $SearchOU -DomainController $DomainController)) {
