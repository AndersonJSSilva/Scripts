...
{
	# We want to read and show the folder permissions
	# $FolderId is the id of the folder we want to check
	...
	if ($Impersonate)
	{
		...
		$FolderId = [Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::MsgFolderRoot
	}
	else
	{
